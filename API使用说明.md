...
```bash
go get -u github.com/zhongshuwen/gmsm
```
## SM2椭圆曲线公钥密码算法
...
- go package： `github.com/zhongshuwen/gmsm/sm2`
...
- g package：`github.com/zhongshuwen/gmsm/sm3`
...
- go package：`github.com/zhongshuwen/gmsm/sm4`

### 代码示例

```Go
    import  "crypto/cipher"
    import  "github.com/zhongshuwen/gmsm/sm4"
    import "fmt"
